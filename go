...
for file in baldrige-page-*.pdf; do tet --tetml wordplus --outfile $file.tetml $file; xsltproc tetml2html.xsl $file.tetml > $file.html; pandoc -s -r html $file.html -o $file.md; done
for i in $(seq 1 35); do cat "baldrige-page-$i.pdf.md" >> baldrige.md; done
rm -rf baldrige-page-*
